...
<hr class="featurette-divider">
        ...
        <div class="row featurette">
          ...
          <div style="margin-top: 15%;">                
              <h3 style="font: bold 60px 'Cookie', cursive;">Order Placed <span style="color:  #e0ac1c;">Successfully</span></h3><br>
              <a href="order.php?action=empty"><button style="background-color: #e0ac1c;border-color:#e0ac1c;border-radius:5px;width:20%"><h5 style="font: bold 30px 'Cookie', cursive;">Order Again</h5></button></a>
          </div>
          </div>
          <div class="col-md-5 order-md-1">
            <img class="featurette-image img-fluid mx-auto" src="product-images/delivery.jpg" data-src="holder.js/500x500/auto" alt="Generic placeholder image">
          </div>
        </div>
